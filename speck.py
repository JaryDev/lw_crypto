...
# https://github.com/ioef/Speck
# Modified code from python2 to python3
# Block size = 128 bits
# Key size = 128 bits
...
if __name__== '__main__':
    ...
    #plaintext = list(get_random_bytes(1024))
    plaintext = list(b"Where is a United states Flag that is never raised or lowered, flies 24 hours a day, seven days a week, yet it is never saluted?") # 128 bytes * 8 = 1024 bits 
    #plaintext = list(b"In addition, Hello world! can be a complete even a new tool chain.")

    print("Initial Plaintext as byte list:%s"%plaintext)
    

    key = list(b"123456778909234234234")
    IV  = list(b"abcdefghijklmnio")
